...
const botname = process.env.BOTNAME || 'RAHEEM-CMD';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'𝗕𝗢𝗧';
const packname = process.env.STICKER_PACKNAME || 'RAHEEM';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || 255763111390';
const owner = dev.split(",");
const menulink = process.env.MENU_LINK || 'https://files.catbox.moe/0gkfv4.jpg';
